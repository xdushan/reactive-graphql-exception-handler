 ...
 *
 */
public class BadRequestException extends GraphQLBaseException {
  
  private static final long serialVersionUID = -5350320076242816959L;
  ...
  public BadRequestException(String message, ErrorCode code) {
    super(message, code, ErrorType.BAD_REQUEST);
  }
