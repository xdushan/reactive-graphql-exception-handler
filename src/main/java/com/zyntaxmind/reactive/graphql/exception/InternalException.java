...
public class InternalException extends GraphQLBaseException {
  ...
  private static final long serialVersionUID = -2215115176191145014L;

  public InternalException() {
    super(ErrorType.INTERNAL_ERROR);
  }
  
  public InternalException(String message, ErrorCode code) {
    super(message, code, ErrorType.INTERNAL_ERROR);
  }
